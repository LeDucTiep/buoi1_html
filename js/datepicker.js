var Calendarify = function () {
    ...
    var Ls = (P, E, l) => E in P ? ml(P, E, {
        ...
        , Q = (P, E) => {
            for (var l in E || (E = {}))
                Jn.call(E, l) && Ls(P, l, E[l]);
            if (Zt)
                for (var l of Zt(E))
                    Qn.call(E, l) && Ls(P, l, E[l]);
            return P
        }
        , Je = (P, E) => _l(P, yl(E));
    var Xn = (P, E) => {
        var l = {};
        for (var B in P)
            Jn.call(P, B) && E.indexOf(B) < 0 && (l[B] = P[B]);
        if (P != null && Zt)
            for (var B of Zt(P))
                E.indexOf(B) < 0 && Qn.call(P, B) && (l[B] = P[B]);
        return l
    }
        ;
    var p = (P, E, l) => (Ls(P, typeof E != "symbol" ? E + "" : E, l),
        l);
    var Ce = (P, E, l) => new Promise((B, j) => {
        var ye = F => {
            try {
                Ee(l.next(F))
            } catch (q) {
    ...
    function g(e) {
        return e._pf == null && (e._pf = Kn()),
            e._pf
    }
    var Jt;
    Array.prototype.some ? Jt = Array.prototype.some : Jt = function (e) {
    ...
    function Qt(e) {
        if (e._isValid == null) {
            ...
            if (e._strict && (n = n && t.charsLeftOver === 0 && t.unusedTokens.length === 0 && t.bigHour === void 0),
    ...
    function pt(e) {
        var t = ue(NaN);
        return e != null ? Se(g(t), e) : g(t).userInvalidated = !0,
            t
    }
    var Fs = l.momentProperties = []
        , Xt = !1;
    function Kt(e, t) {
        var s, n, r, a = Fs.length;
...
[` + a + "] ";
                        for (i in arguments[0])
                            D(arguments[0], i) && (r += i + ": " + arguments[0][i] + ", ");
                        r = r.slice(0, -2)
                    } else
                        r = arguments[a];
                    n.push(r)
...
` + new Error().stack),
    ...
    function es(e, t) {
        var s = Se({}, e), n;
        for (n in t)
            D(t, n) && (ye(e[n]) && ye(t[n]) ? (s[n] = {},
                Se(s[n], e[n]),
                Se(s[n], t[n])) : t[n] != null ? s[n] = t[n] : delete s[n]);
        for (n in e)
            D(e, n) && !D(t, n) && ye(e[n]) && (s[n] = Se({}, s[n]));
        return s
    }
    function ts(e) {
        e != null && this.set(e)
    ...
    function rr(e) {
        var t = e.match(ns), s, n;
        for (s = 0,
            n = t.length; s < n; s++)
            Ae[t[s]] ? t[s] = Ae[t[s]] : t[s] = nr(t[s]);
        return function (r) {
            var a = "", i;
            for (i = 0; i < n; i++)
    ...
    function gt(e, t) {
        return e.isValid() ? (t = Is(t, e.localeData()),
            rs[t] = rs[t] || rr(t),
            rs[t](e)) : e.localeData().invalidDate()
    }
    function Is(e, t) {
        var s = 5;
        function n(r) {
        ...
        for (wt.lastIndex = 0; s >= 0 && wt.test(e);)
            e = e.replace(wt, n),
                wt.lastIndex = 0,
                s -= 1;
        return e
    ...
    function ir(e) {
        ...
        return t || !s ? t : (this._longDateFormat[e] = s.match(ns).map(function (n) {
    ...
    function v(e) {
        var t = +e
            , s = 0;
        return t !== 0 && isFinite(t) && (s = ee(t)),
            s
    }
    function Ie(e, t) {
        return function (s) {
            return s != null ? (Us(this, e, s),
    ...
    function Us(e, t, s) {
        e.isValid() && !isNaN(s) && (t === "FullYear" && vt(e.year()) && e.month() === 1 && e.date() === 29 ? (s = v(s),
            e._d["set" + (e._isUTC ? "UTC" : "") + t](s, e.month(), Ot(s, e.month()))) : e._d["set" + (e._isUTC ? "UTC" : "") + t](s))
    }
    function yr(e) {
        return e = K(e),
            he(this[e]) ? this[e]() : this
    }
    function pr(e, t) {
        if (typeof e == "object") {
            e = as(e);
            var s = _r(e), n, r = s.length;
            for (n = 0; n < r; n++)
    ...
    var $s = /\d/, z = /\d\d/, Vs = /\d{3}/, is = /\d{4}/, Dt = /[+-]?\d{6}/, O = /\d\d?/, Gs = /\d\d\d\d?/, js = /\d\d\d\d\d\d?/, Mt = /\d{1,3}/, os = /\d{1,4}/, St = /[+-]?\d{1,6}/, He = /\d+/, Yt = /[+-]?\d+/, wr = /Z|[+-]\d\d:?\d\d/gi, bt = /Z|[+-]\d\d(?::?\d\d)?/gi, gr = /[+-]?\d+(\.\d{1,3})?/, et = /[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFF07\uFF10-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\s*?[\u0600-\u06FF]{1,256}){1,2}/i, xt;
    xt = {};
    function f(e, t, s) {
        xt[e] = he(t) ? t : function (n, r) {
            return n && s ? s : t
        }
    }
    function vr(e, t) {
    ...
    function kr(e) {
        return Z(e.replace("\\", "").replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g, function (t, s, n, r, a) {
            return s || n || r || a
        }))
    }
    function Z(e) {
    ...
    function Er(e, t, s) {
        ...
        return s ? t === "MMM" ? (r = C.call(this._shortMonthsParse, i),
            r !== -1 ? r : null) : (r = C.call(this._longMonthsParse, i),
                r !== -1 ? r : null) : t === "MMM" ? (r = C.call(this._shortMonthsParse, i),
                    r !== -1 ? r : (r = C.call(this._longMonthsParse, i),
                        r !== -1 ? r : null)) : (r = C.call(this._longMonthsParse, i),
                            r !== -1 ? r : (r = C.call(this._shortMonthsParse, i),
                                r !== -1 ? r : null))
    }
    function Wr(e, t, s) {
        var n, r, a;
        ...
        for (this._monthsParse || (this._monthsParse = [],
            ...
            n = 0; n < 12; n++) {
            if (r = ue([2e3, n]),
                s && !this._longMonthsParse[n] && (this._longMonthsParse[n] = new RegExp("^" + this.months(r, "").replace(".", "") + "$", "i"),
                    this._shortMonthsParse[n] = new RegExp("^" + this.monthsShort(r, "").replace(".", "") + "$", "i")),
                !s && !this._monthsParse[n] && (a = "^" + this.months(r, "") + "|^" + this.monthsShort(r, ""),
    ...
    function zs(e, t) {
        ...
        return s = Math.min(e.date(), Ot(e.year(), t)),
            e._d["set" + (e._isUTC ? "UTC" : "") + "Month"](t, s),
            e
    }
    function Zs(e) {
        return e != null ? (zs(this, e),
    ...
    function Pr(e) {
        return this._monthsParseExact ? (D(this, "_monthsRegex") || Js.call(this),
            e ? this._monthsShortStrictRegex : this._monthsShortRegex) : (D(this, "_monthsShortRegex") || (this._monthsShortRegex = xr),
                this._monthsShortStrictRegex && e ? this._monthsShortStrictRegex : this._monthsShortRegex)
    }
    function Fr(e) {
        return this._monthsParseExact ? (D(this, "_monthsRegex") || Js.call(this),
            e ? this._monthsStrictRegex : this._monthsRegex) : (D(this, "_monthsRegex") || (this._monthsRegex = Or),
    ...
    function Cr(e, t, s, n, r, a, i) {
        var o;
        return e < 100 && e >= 0 ? (o = new Date(e + 400, t, s, n, r, a, i),
            isFinite(o.getFullYear()) && o.setFullYear(e)) : o = new Date(e, t, s, n, r, a, i),
            o
    }
    function nt(e) {
        var t, s;
    ...
    function Xs(e, t, s, n, r) {
        var a = (7 + s - n) % 7, i = Tt(e, n, r), o = 1 + 7 * (t - 1) + a + i, u, d;
        return o <= 0 ? (u = e - 1,
            d = st(u) + o) : o > st(e) ? (u = e + 1,
                d = o - st(e)) : (u = e,
                    d = o),
        {
            year: u,
    ...
    function rt(e, t, s) {
        ...
        return r < 1 ? (i = e.year() - 1,
            a = r + ge(i, t, s)) : r > ge(e.year(), t, s) ? (a = r - ge(e.year(), t, s),
                i = e.year() + 1) : (i = e.year(),
                    a = r),
        {
            week: a,
    ...
    function ea(e, t, s) {
        ...
        return s ? t === "dddd" ? (r = C.call(this._weekdaysParse, i),
            r !== -1 ? r : null) : t === "ddd" ? (r = C.call(this._shortWeekdaysParse, i),
                r !== -1 ? r : null) : (r = C.call(this._minWeekdaysParse, i),
                    r !== -1 ? r : null) : t === "dddd" ? (r = C.call(this._weekdaysParse, i),
                        r !== -1 || (r = C.call(this._shortWeekdaysParse, i),
                            r !== -1) ? r : (r = C.call(this._minWeekdaysParse, i),
                                r !== -1 ? r : null)) : t === "ddd" ? (r = C.call(this._shortWeekdaysParse, i),
                                    r !== -1 || (r = C.call(this._weekdaysParse, i),
                                        r !== -1) ? r : (r = C.call(this._minWeekdaysParse, i),
                                            r !== -1 ? r : null)) : (r = C.call(this._minWeekdaysParse, i),
                                                r !== -1 || (r = C.call(this._weekdaysParse, i),
                                                    r !== -1) ? r : (r = C.call(this._shortWeekdaysParse, i),
                                                        r !== -1 ? r : null))
    }
    function ta(e, t, s) {
        var n, r, a;
        ...
        for (this._weekdaysParse || (this._weekdaysParse = [],
            ...
            n = 0; n < 7; n++) {
            if (r = ue([2e3, 1]).day(n),
                s && !this._fullWeekdaysParse[n] && (this._fullWeekdaysParse[n] = new RegExp("^" + this.weekdays(r, "").replace(".", "\\.?") + "$", "i"),
                ...
                this._weekdaysParse[n] || (a = "^" + this.weekdays(r, "") + "|^" + this.weekdaysShort(r, "") + "|^" + this.weekdaysMin(r, ""),
    ...
    function sa(e) {
        ...
        return e != null ? (e = Gr(e, this.localeData()),
            this.add(e - t, "d")) : t
    }
    function na(e) {
        if (!this.isValid())
    ...
    function aa(e) {
        return this._weekdaysParseExact ? (D(this, "_weekdaysRegex") || hs.call(this),
            e ? this._weekdaysStrictRegex : this._weekdaysRegex) : (D(this, "_weekdaysRegex") || (this._weekdaysRegex = zr),
                this._weekdaysStrictRegex && e ? this._weekdaysStrictRegex : this._weekdaysRegex)
    }
    function ia(e) {
        return this._weekdaysParseExact ? (D(this, "_weekdaysRegex") || hs.call(this),
            e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex) : (D(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = Zr),
                this._weekdaysShortStrictRegex && e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex)
    }
    function oa(e) {
        return this._weekdaysParseExact ? (D(this, "_weekdaysRegex") || hs.call(this),
            e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex) : (D(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Jr),
    ...
    function hs() {
        ...
        for (a = 0; a < 7; a++)
            i = ue([2e3, 1]).day(a),
                o = Z(this.weekdaysMin(i, "")),
                u = Z(this.weekdaysShort(i, "")),
                d = Z(this.weekdays(i, "")),
                t.push(o),
                s.push(u),
                n.push(d),
    ...
    function ma(e) {
        for (var t = 0, s, n, r, a; t < e.length;) {
            for (a = nn(e[t]).split("-"),
                s = a.length,
                n = nn(e[t + 1]),
                n = n ? n.split("-") : null; s > 0;) {
                if (r = Rt(a.slice(0, s).join("-")),
                    r)
                    return r;
                if (n && n.length >= s && fa(a, n) >= s - 1)
                    break;
                s--
            }
            t++
    ...
    function Ye(e, t) {
        var s;
        return e && (F(t) ? s = ve(e) : s = cs(e, t),
            s ? it = s : typeof console != "undefined" && console.warn && console.warn("Locale " + e + " not found. Did you forget to load it?")),
            it._abbr
    }
    function cs(e, t) {
        if (t !== null) {
            ...
            if (t.abbr = e,
                ...
                if (W[t.parentLocale] != null)
                    ...
                    return at[t.parentLocale] || (at[t.parentLocale] = []),
                        ...
                        null;
            return W[e] = new ts(es(n, t)),
                at[e] && at[e].forEach(function (r) {
                    cs(r.name, r.config)
                }),
                Ye(e),
                W[e]
    ...
    function ya(e, t) {
        if (t != null) {
            var s, n, r = sn;
            W[e] != null && W[e].parentLocale != null ? W[e].set(es(W[e]._config, t)) : (n = Rt(e),
                n != null && (r = n._config),
                t = es(r, t),
                n == null && (t.abbr = e),
                s = new ts(t),
            ...
            W[e] != null && (W[e].parentLocale != null ? (W[e] = W[e].parentLocale,
                e === Ye() && Ye(e)) : W[e] != null && delete W[e]);
        return W[e]
    }
    function ve(e) {
        var t;
    ...
    function fs(e) {
        var t, s = e._a;
        return s && g(e).overflow === -2 && (t = s[pe] < 0 || s[pe] > 11 ? pe : s[ce] < 1 || s[ce] > Ot(s[$], s[pe]) ? ce : s[A] < 0 || s[A] > 24 || s[A] === 24 && (s[ae] !== 0 || s[we] !== 0 || s[We] !== 0) ? A : s[ae] < 0 || s[ae] > 59 ? ae : s[we] < 0 || s[we] > 59 ? we : s[We] < 0 || s[We] > 999 ? We : -1,
    ...
    var wa = /^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([+-]\d\d(?::?\d\d)?|\s*Z)?)?$/
        ...
        , va = /Z|[+-]\d\d(?::?\d\d)?/
        , Et = [["YYYYYY-MM-DD", /[+-]\d{6}-\d\d-\d\d/], ["YYYY-MM-DD", /\d{4}-\d\d-\d\d/], ["GGGG-[W]WW-E", /\d{4}-W\d\d-\d/], ["GGGG-[W]WW", /\d{4}-W\d\d/, !1], ["YYYY-DDD", /\d{4}-\d{3}/], ["YYYY-MM", /\d{4}-\d\d/, !1], ["YYYYYYMMDD", /[+-]\d{10}/], ["YYYYMMDD", /\d{8}/], ["GGGG[W]WWE", /\d{4}W\d{3}/], ["GGGG[W]WW", /\d{4}W\d{2}/, !1], ["YYYYDDD", /\d{7}/], ["YYYYMM", /\d{6}/, !1], ["YYYY", /\d{4}/, !1]]
    ...
    function rn(e) {
        var t, s, n = e._i, r = wa.exec(n) || ga.exec(n), a, i, o, u, d = Et.length, _ = ms.length;
        if (r) {
            for (g(e).iso = !0,
                t = 0,
                s = d; t < s; t++)
    ...
    function an(e) {
        var t = Da.exec(ba(e._i)), s;
        if (t) {
            if (s = Sa(t[4], t[3], t[2], t[5], t[6], t[7]),
                !xa(t[1], s, e))
                return;
            e._a = s,
                e._tzm = Oa(t[8], t[9], t[10]),
                e._d = nt.apply(null, e._a),
    ...
    function _s(e) {
        ...
        if (!e._d) {
            for (r = Ra(e),
                ...
                e._dayOfYear != null && (i = Ue(e._a[$], r[$]),
                    (e._dayOfYear > st(i) || e._dayOfYear === 0) && (g(e)._overflowDayOfYear = !0),
                    s = nt(i, 0, e._dayOfYear),
                    e._a[pe] = s.getUTCMonth(),
                    e._a[ce] = s.getUTCDate()),
                t = 0; t < 3 && e._a[t] == null; ++t)
                e._a[t] = n[t] = r[t];
            for (; t < 7; t++)
                e._a[t] = n[t] = e._a[t] == null ? t === 2 ? 1 : 0 : e._a[t];
            e._a[A] === 24 && e._a[ae] === 0 && e._a[we] === 0 && e._a[We] === 0 && (e._nextDay = !0,
                e._a[A] = 0),
    ...
    function Ea(e) {
        var t, s, n, r, a, i, o, u, d;
        t = e._w,
            t.GG != null || t.W != null || t.E != null ? (a = 1,
                i = 4,
                s = Ue(t.GG, e._a[$], rt(T(), 1, 4).year),
                n = Ue(t.W, 1),
                r = Ue(t.E, 1),
                (r < 1 || r > 7) && (u = !0)) : (a = e._locale._week.dow,
                    i = e._locale._week.doy,
                    d = rt(T(), a, i),
                    s = Ue(t.gg, e._a[$], d.year),
                    n = Ue(t.w, d.week),
                    t.d != null ? (r = t.d,
                        (r < 0 || r > 6) && (u = !0)) : t.e != null ? (r = t.e + a,
                            (t.e < 0 || t.e > 6) && (u = !0)) : r = a),
            n < 1 || n > ge(s, a, i) ? g(e)._overflowWeeks = !0 : u != null ? g(e)._overflowWeekday = !0 : (o = Xs(s, n, r, a, i),
                e._a[$] = o.year,
    ...
    function ys(e) {
        ...
        for (r = Is(e._f, e._locale).match(ns) || [],
            _ = r.length,
            s = 0; s < _; s++)
            a = r[s],
                n = (t.match(vr(a, e)) || [])[0],
                n && (i = t.substr(0, t.indexOf(n)),
                    i.length > 0 && g(e).unusedInput.push(i),
                    t = t.slice(t.indexOf(n) + n.length),
                    u += n.length),
                Ae[a] ? (n ? g(e).empty = !1 : g(e).unusedTokens.push(a),
                    Dr(a, n, e)) : e._strict && !n && g(e).unusedTokens.push(a);
    ...
    function Wa(e, t, s) {
        var n;
        return s == null ? t : e.meridiemHour != null ? e.meridiemHour(t, s) : (e.isPM != null && (n = e.isPM(s),
            n && t < 12 && (t += 12),
            !n && t === 12 && (t = 0)),
            t)
    }
    ...
    function on(e) {
        ...
        return e._locale = e._locale || ve(e._l),
            t === null || s === void 0 && t === "" ? pt({
                nullInput: !0
            }) : (typeof t == "string" && (e._i = t = e._locale.preparse(t)),
                re(t) ? new Xe(fs(t)) : (Qe(t) ? e._d = t : j(s) ? La(e) : s ? ys(e) : Na(e),
                    Qt(e) || (e._d = null),
                    e))
    }
    function Na(e) {
        var t = e._i;
        F(t) ? e._d = new Date(l.now()) : Qe(t) ? e._d = new Date(t.valueOf()) : typeof t == "string" ? Ta(e) : j(t) ? (e._a = Ps(t.slice(0), function (s) {
            return parseInt(s, 10)
        }),
            _s(e)) : ye(t) ? Pa(e) : q(t) ? e._d = new Date(t) : l.createFromInputFallback(e)
    }
    ...
    function $a(e) {
        var t, s = !1, n, r = ot.length;
        for (t in e)
            if (D(e, t) && !(C.call(ot, t) !== -1 && (e[t] == null || !isNaN(e[t]))))
                return !1;
        for (n = 0; n < r; ++n)
            if (e[ot[n]]) {
                if (s)
    ...
    function Wt(e) {
        var t = as(e)
            ...
            , _ = t.millisecond || 0;
        this._isValid = $a(t),
            this._milliseconds = +_ + d * 1e3 + u * 6e4 + o * 1e3 * 60 * 60,
            this._days = +i + a * 7,
    ...
    function gs(e, t) {
        ...
        return t._isUTC ? (s = t.clone(),
            n = (re(e) || Qe(e) ? e.valueOf() : T(e).valueOf()) - s.valueOf(),
    ...
    function qa(e, t, s) {
        ...
        if (e != null) {
            ...
            return !this._isUTC && t && (r = vs(this)),
                this._offset = e,
                this._isUTC = !0,
                r != null && this.add(r, "m"),
                n !== e && (!t || this._changeInProgress ? mn(this, ie(e - n, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0,
                    l.updateOffset(this, !0),
                    this._changeInProgress = null)),
                this
        } else
            return this._isUTC ? n : vs(this)
    }
    function za(e, t) {
    ...
    function Xa(e) {
        return this.isValid() ? (e = e ? T(e).utcOffset() : 0,
    ...
    function ei() {
        ...
        return Kt(e, this),
            e = on(e),
            e._a ? (t = e._isUTC ? ue(e._a) : T(e._a),
                this._isDSTShifted = this.isValid() && ja(e._a, t.toArray()) > 0) : this._isDSTShifted = !1,
            this._isDSTShifted
    }
    function ti() {
    ...
    function ie(e, t) {
        ...
        return Lt(e) ? s = {
            ...
            t ? s[t] = +e : s.milliseconds = +e) : (n = ni.exec(e)) ? (r = n[1] === "-" ? -1 : 1,
                s = {
                    y: 0,
                    d: v(n[ce]) * r,
                    h: v(n[A]) * r,
                    ...
                    s = {
                        ...
                        m: Le(n[7], r),
                        s: Le(n[8], r)
                    }) : s == null ? s = {} : typeof s == "object" && ("from" in s || "to" in s) && (i = ai(T(s.from), T(s.to)),
                        s = {},
                        s.ms = i.milliseconds,
                        s.M = i.months),
            a = new Wt(s),
    ...
    function ai(e, t) {
        var s;
        return e.isValid() && t.isValid() ? (t = gs(t, e),
            e.isBefore(t) ? s = cn(e, t) : (s = cn(t, e),
    ...
    function fn(e, t) {
        return function (s, n) {
            var r, a;
            return n !== null && !isNaN(+n) && (As(t, "moment()." + t + "(period, number) is deprecated. Please use moment()." + t + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."),
                a = s,
                s = n,
                n = a),
                r = ie(s, n),
    ...
    function mn(e, t, s, n) {
        ...
        e.isValid() && (n = n == null ? !0 : n,
            i && zs(e, kt(e, "Month") + i * s),
            a && Us(e, "Date", kt(e, "Date") + a * s),
            r && e._d.setTime(e._d.valueOf() + r * s),
            n && l.updateOffset(e, a || i))
    }
    var ii = fn(1, "add")
        , oi = fn(-1, "subtract");
    function _n(e) {
    ...
    function ui(e) {
        var t = ye(e) && !Ee(e), s = !1, n = ["years", "year", "y", "months", "month", "M", "days", "day", "d", "dates", "date", "D", "hours", "hour", "h", "minutes", "minute", "m", "seconds", "second", "s", "milliseconds", "millisecond", "ms"], r, a, i = n.length;
        for (r = 0; r < i; r += 1)
            a = n[r],
                s = s || D(e, a);
        return t && s
    ...
    function di(e) {
        var t = ye(e) && !Ee(e), s = !1, n = ["sameDay", "nextDay", "lastDay", "nextWeek", "lastWeek", "sameElse"], r, a;
    ...
    function fi(e, t) {
        arguments.length === 1 && (arguments[0] ? li(arguments[0]) ? (e = arguments[0],
            t = void 0) : di(arguments[0]) && (t = arguments[0],
                e = void 0) : (e = void 0,
                    t = void 0));
        var s = e || T()
    ...
    function _i(e, t) {
        var s = re(e) ? e : T(e);
        return this.isValid() && s.isValid() ? (t = K(t) || "millisecond",
    ...
    function pi(e, t, s, n) {
        var r = re(e) ? e : T(e)
            , a = re(t) ? t : T(t);
        return this.isValid() && r.isValid() && a.isValid() ? (n = n || "()",
            (n[0] === "(" ? this.isAfter(r, s) : !this.isBefore(r, s)) && (n[1] === ")" ? this.isBefore(a, s) : !this.isAfter(a, s))) : !1
    }
    function wi(e, t) {
        var s = re(e) ? e : T(e), n;
        return this.isValid() && s.isValid() ? (t = K(t) || "millisecond",
            t === "millisecond" ? this.valueOf() === s.valueOf() : (n = s.valueOf(),
    ...
    function ki(e, t, s) {
        ...
        if (n = gs(e, this),
            !n.isValid())
            return NaN;
        switch (r = (n.utcOffset() - this.utcOffset()) * 6e4,
        t = K(t),
        t) {
            case "year":
                a = Pt(this, n) / 12;
    ...
    function Pt(e, t) {
        ...
        return t - n < 0 ? (r = e.clone().add(s - 1, "months"),
            a = (t - n) / (n - r)) : (r = e.clone().add(s + 1, "months"),
                a = (t - n) / (r - n)),
            -(s + a) || 0
    }
    ...
    function Mi(e) {
        ...
        return s.year() < 0 || s.year() > 9999 ? gt(s, t ? "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYYYY-MM-DD[T]HH:mm:ss.SSSZ") : he(Date.prototype.toISOString) ? t ? this.toDate().toISOString() : new Date(this.valueOf() + this.utcOffset() * 60 * 1e3).toISOString().replace("Z", gt(s, "Z")) : gt(s, t ? "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYY-MM-DD[T]HH:mm:ss.SSSZ")
    }
    function Si() {
        if (!this.isValid())
    ...
    function bi(e, t) {
        return this.isValid() && (re(e) && e.isValid() || T(e).isValid()) ? ie({
            to: this,
            from: e
    ...
    function yn(e) {
        var t;
        return e === void 0 ? this._locale._abbr : (t = ve(e),
    ...
    function Ri(e) {
        ...
        e) {
            ...
            case "hour":
                t = this._d.valueOf(),
                    t -= Ve(t + (this._isUTC ? 0 : this.utcOffset() * $e), Nt);
                break;
            case "minute":
                t = this._d.valueOf(),
                    t -= Ve(t, $e);
    ...
    function Ei(e) {
        ...
        e) {
            ...
            case "hour":
                t = this._d.valueOf(),
                    t += Nt - Ve(t + (this._isUTC ? 0 : this.utcOffset() * $e), Nt) - 1;
                break;
            case "minute":
                t = this._d.valueOf(),
                    t += $e - Ve(t, $e) - 1;
    ...
    y("N", 0, 0, "eraAbbr"),
        ...
        b(["yo"], function (e, t, s, n) {
            var r;
            s._locale._eraYearOrdinalRegex && (r = e.match(s._locale._eraYearOrdinalRegex)),
                s._locale.eraYearOrdinalParse ? t[$] = s._locale.eraYearOrdinalParse(e, r) : t[$] = parseInt(e, 10)
        });
    function $i(e, t) {
        ...
        for (s = 0,
            ...
            switch (typeof a[s].until) {
                case "undefined":
                    ...
                    break;
                case "string":
                    r = l(a[s].until).startOf("day").valueOf(),
                        a[s].until = r.valueOf();
                    break
            }
        }
    ...
    function Zi(e) {
        return D(this, "_erasNameRegex") || Ds.call(this),
            e ? this._erasNameRegex : this._erasRegex
    }
    function Ji(e) {
        return D(this, "_erasAbbrRegex") || Ds.call(this),
            e ? this._erasAbbrRegex : this._erasRegex
    }
    function Qi(e) {
        return D(this, "_erasNarrowRegex") || Ds.call(this),
    ...
    function Dn(e, t, s, n, r) {
        var a;
        return e == null ? rt(this, n, r).year : (a = ge(e, n, r),
            t > a && (t = a),
            oo.call(this, e, t, s, n, r))
    }
        ...
        typeof e == "boolean" ? (q(t) && (s = t,
            ...
            t = t || "") : (t = e,
                ...
                q(t) && (s = t,
                    t = void 0),
                t = t || "");
        var r = ve(), a = e ? r._week.dow : 0, i, o = [];
        if (s != null)
            return At(t, (s + a) % 7, n, "day");
        for (i = 0; i < 7; i++)
            o[i] = At(t, (i + a) % 7, n, "day");
        return o
    }
    function wo(e, t) {
    ...
    function Mo() {
        var e = this._data;
        return this._milliseconds = ke(this._milliseconds),
    ...
    function bo() {
        ...
        return e >= 0 && t >= 0 && s >= 0 || e <= 0 && t <= 0 && s <= 0 || (e += On(Ss(s) + t) * 864e5,
            t = 0,
            s = 0),
    ...
    function xo(e) {
        ...
        if (e = K(e),
            ...
            switch (t = this._days + Math.round(Ss(this._months)),
            e) {
                case "week":
                    return t / 7 + n / 6048e5;
                case "day":
    ...
    function Zo(e, t, s, n) {
        ...
        return s.w != null && (m = m || _ <= 1 && ["w"] || _ < s.w && ["ww", _]),
            m = m || d <= 1 && ["M"] || d < s.M && ["MM", d] || c <= 1 && ["y"] || ["yy", c],
            m[2] = t,
            m[3] = +e > 0,
            m[4] = n,
            zo.apply(null, m)
    ...
    function Qo(e, t) {
        return Ge[e] === void 0 ? !1 : t === void 0 ? Ge[e] : (Ge[e] = t,
            e === "s" && (Ge.ss = t - 1),
            !0)
    }
    function Xo(e, t) {
        ...
        return typeof e == "object" && (t = e,
            ...
            typeof t == "object" && (n = Object.assign({}, Ge, t),
    ...
    function It() {
        if (!this.isValid())
            return this.localeData().invalidDate();
        var e = Ys(this._milliseconds) / 1e3, t = Ys(this._days), s = Ys(this._months), n, r, a, i, o = this.asSeconds(), u, d, _, c;
        return o ? (n = ee(e / 60),
            r = ee(n / 60),
            e %= 60,
            n %= 60,
            ...
            u + "P" + (a ? d + a + "Y" : "") + (s ? d + s + "M" : "") + (t ? _ + t + "D" : "") + (r || n || e ? "T" : "") + (r ? c + r + "H" : "") + (n ? c + n + "M" : "") + (e ? c + i + "S" : "")) : "P0D"
    }
    var M = Wt.prototype;
    M.isValid = Va,
        M.abs = Mo,
    ...
    const Ko = (e, t, s) => Ce(this, null, function* () {
        ...
        for (let S = 0; S < o.length; S++) {
            const { name: x, fn: R } = o[S]
                , { x: L, y: N, data: I, reset: te } = yield R({
                    x: _,
                    y: c,
                    initialPlacement: n,
                    placement: m,
            ...
            _ = L != null ? L : _,
                ...
                te && k <= 50 && (k++,
                    typeof te == "object" && (te.placement && (m = te.placement),
                        te.rects && (d = te.rects === !0 ? yield i.getElementRects({
                            reference: e,
                            floating: t,
                            strategy: r
                        }) : te.rects),
    ...
    function tl(e, t) {
        return Ce(this, null, function* () {
            ...
            const { x: n, y: r, platform: a, rects: i, elements: o, strategy: u } = e
                ...
                , R = c === "floating" ? Je(Q({}, i.floating), {
                    x: n,
                    y: r
                }) : i.reference
                , L = yield a.getOffsetParent == null ? void 0 : a.getOffsetParent(o.floating)
                , N = (yield a.isElement == null ? void 0 : a.isElement(L)) && (yield a.getScale == null ? void 0 : a.getScale(L)) || {
                    x: 1,
                    y: 1
                }
                , I = xs(a.convertOffsetParentRelativeRectToViewportRelativeRect ? yield a.convertOffsetParentRelativeRectToViewportRelativeRect({
                    rect: R,
                    offsetParent: L,
                    strategy: u
                }) : R);
            return {
                top: (x.top - I.top + k.top) / N.y,
                bottom: (I.bottom - x.bottom + k.bottom) / N.y,
                left: (x.left - I.left + k.left) / N.x,
                right: (I.right - x.right + k.right) / N.x
            }
        })
    }
    ...
    function nl(e, t, s) {
        ...
        return t.reference[a] > t.floating[a] && (i = Ut(i)),
        {
            main: i,
            cross: Ut(i)
        }
            ...
            fn(s) {
                return Ce(this, null, function* () {
                    ...
                    const { placement: r, middlewareData: a, rects: i, initialPlacement: o, platform: u, elements: d } = s
                        ...
                        , I = m || (L || !S ? [Ut(o)] : function (V) {
                            const se = Ut(V);
                            return [Os(V), se, Os(se)]
                        }(o));
                    m || k === "none" || I.push(...function (V, se, _e, le) {
                        const ne = Ht(V);
                        ...
                        return ne && (G = G.map(Re => Re + "-" + ne),
                            se && (G = G.concat(G.map(Os)))),
                            G
                    }(o, S, k, N));
                    const te = [o, ...I]
                        , ze = yield tl(s, x)
                        ...
                        const { x: n, y: r } = s
                            , a = yield function (i, o) {
                                return Ce(this, null, function* () {
                                    ...
                                    let { mainAxis: L, crossAxis: N, alignmentAxis: I } = typeof R == "number" ? {
                                        mainAxis: R,
                                        crossAxis: 0,
                                        alignmentAxis: null
                                    } : Q({
                                    ...
                                    return w && typeof I == "number" && (N = w === "end" ? -1 * I : I),
                                        k ? {
                                            x: N * x,
                                            y: L * S
                                        } : {
    ...
    function Pn() {
        ...
        return e && Array.isArray(e.brands) ? (Vt = e.brands.map(t => t.brand + "/" + t.version).join(" "),
    ...
    function Fe(e, t, s, n) {
        ...
        if (o) {
            ...
            for (; R && n && x !== S;) {
                ...
                N.x += (R.clientLeft + parseFloat(I.paddingLeft)) * L.x,
                    N.y += (R.clientTop + parseFloat(I.paddingTop)) * L.y,
                    c *= L.x,
                    m *= L.y,
                    w *= L.x,
                    k *= L.y,
    ...
    function Un(e, t, s) {
        ...
        if (t === "viewport")
            ...
            n = function (i) {
                ...
                const w = -u.scrollTop;
                return fe(d).direction === "rtl" && (m += lt(o.clientWidth, d.clientWidth) - _),
                {
                    width: _,
                    height: c,
                    x: m,
            ...
            if (Rs()) {
                var r, a;
                const o = J(e);
                i.x -= ((r = o.visualViewport) == null ? void 0 : r.offsetLeft) || 0,
                    i.y -= ((a = o.visualViewport) == null ? void 0 : a.offsetTop) || 0
            }
            n = i
        }
        return xs(n)
    ...
    function Vn(e, t) {
        const s = J(e);
        let n = $n(e, t);
        for (; n && ol(n) && fe(n).position === "static";)
            n = $n(n, t);
        return n && (xe(n) === "html" || xe(n) === "body" && fe(n).position === "static" && !Ts(n)) ? s : n || function (r) {
            let a = ut(r);
            for (; me(a) && !Es(a);) {
                if (Ts(a))
                    return a;
    ...
    function ll(e, t, s) {
        ...
        if (n || !n && s !== "fixed")
            if ((xe(t) !== "body" || Gt(r)) && (i = jt(t)),
                me(t)) {
                const u = Fe(t, !0);
                o.x = u.x + t.clientLeft,
                    o.y = u.y + t.clientTop
            } else
                r && (o.x = In(r));
        return {
    ...
    const ul = {
        getClippingRect: function (e) {
            ...
            const a = s === "clippingAncestors" ? function (d, _) {
                ...
                for (; oe(S) && !Es(S);) {
                    const x = fe(S)
                        , R = Ts(S);
                    x.position === "fixed" ? w = null : (k ? R || w : R || x.position !== "static" || !w || !["absolute", "fixed"].includes(w.position)) ? w = x : m = m.filter(L => L !== S),
                        S = ut(S)
                }
                return _.set(d, m),
                    m
                ...
                , u = i.reduce((d, _) => {
                    const c = Un(t, _, r);
                    return d.top = lt(c.top, d.top),
                        d.right = Wn(c.right, d.right),
                        d.bottom = Wn(c.bottom, d.bottom),
                        d.left = lt(c.left, d.left),
                        d
                }
                    , Un(t, o, r));
            return {
        ...
        convertOffsetParentRelativeRectToViewportRelativeRect: function (e) {
            ...
            if ((r || !r && n !== "fixed") && ((xe(s) !== "body" || Gt(a)) && (i = jt(s)),
                me(s))) {
                const d = Fe(s);
                o = qe(s),
                    u.x = d.x + s.clientLeft,
                    u.y = d.y + s.clientTop
            }
            return {
                width: t.width * o.x,
                height: t.height * o.y,
                x: t.x * o.x - i.scrollLeft * o.x + u.x,
                y: t.y * o.y - i.scrollTop * o.y + u.y
            }
        },
        isElement: oe,
    ...
    function hl(e, t, s, n) {
        ...
        d.forEach(w => {
            u && w.addEventListener("scroll", s, {
                passive: !0
            }),
                a && w.addEventListener("resize", s)
        }
        );
        let _, c = null;
        if (i) {
        ...
        return o && function w() {
            const k = Fe(e);
            !m || k.x === m.x && k.y === m.y && k.width === m.width && k.height === m.height || s(),
                m = k,
            ...
            () => {
                var w;
                d.forEach(k => {
                    u && k.removeEventListener("scroll", s),
                        a && k.removeEventListener("resize", s)
                }
                ),
    ...
    <div class="calendarify__calendar">
      ...
      <ul class="dates-wrapper wrapper">
          ${this.dates.map(m => `<li><button ${m.disabled ? "disabled" : ""} type="button" class="date-button ${this.getHolidayClass({
                date: m.date,
                nowMonth: this.nowMonth
            })} ${this.nowDay == String(m.date) ? "active" : ""}">${m.date}</button></li>`).join("")}
      </ul>
      ...
      <ul class="years-wrapper wrapper d-none">
        ...
        getHolidayClass(t) {
            const { nowMonth: s, date: n } = t
                ...
                , i = r === 6;
            let o = "";
            return a ? o = "holiday" : i && (o = "pre-holiday"),
                o
        }
    }
    class fl {
            ...
            this.options = Object.assign(this, s),
                ...
                this.locale = {
                    ...
                    lang: {
                        ...
                        ui: {
                            quickActions: {
                                today: (R = (x = (S = (k = (w = (m = this.options) == null ? void 0 : m.locale) == null ? void 0 : w.lang) == null ? void 0 : k.ui) == null ? void 0 : S.quickActions) == null ? void 0 : x.today) != null ? R : "Today",
                                tomorrow: (Ne = (ze = (te = (I = (N = (L = this.options) == null ? void 0 : L.locale) == null ? void 0 : N.lang) == null ? void 0 : I.ui) == null ? void 0 : te.quickActions) == null ? void 0 : ze.tomorrow) != null ? Ne : "Tomorrow",
                                inTwoDays: (V = (mt = (ft = (ct = (dt = (Te = this.options) == null ? void 0 : Te.locale) == null ? void 0 : dt.lang) == null ? void 0 : ct.ui) == null ? void 0 : ft.quickActions) == null ? void 0 : mt.inTwoDays) != null ? V : "In 2 Days"
                            }
                        },
        ...
        hideOnOutsideClick(t) {
            const s = t.target;
            !s.closest(this._inputSelector) && !s.closest(".calendarify") && (this._container.classList.remove("show"),
                this.doneState(),
                this._wasExecuted = !1)
        }
        expand() {
            this._isExpanded = !0,
                this._expandButton.textContent = l(this._date).format("YYYY"),
                this._wrapperEls.forEach(t => t.classList.add("d-none")),
        ...
        showMonths() {
            ...
            t.forEach(s => s.addEventListener("click", n => this.changeMonth(n, t))),
        ...
        changeState() {
            ...
            switch (this._expandButton.textContent = `${(n = this.locale.lang) == null ? void 0 : n.months[+t - 1]} ${s}`,
            this._expandedMode) {
                case "years":
            ...
            if (this._isExpanded)
                switch (this._expandedMode) {
                    case "months":
                        ...
                        break;
                    default:
                        this._date = l(`${this._nowMonth}-${this._nowDay}`).subtract(10, "years").format(this._systemFormat),
                            this.showYears();
                        break
                }
            else
            ...
            if (this._isExpanded)
                switch (this._expandedMode) {
                    case "months":
                        ...
                        break;
                    default:
                        this._date = l(`${this._nowMonth}-${this._nowDay}`).add(10, "years").format(this._systemFormat),
                            this.showYears();
                        break
                }
            else
